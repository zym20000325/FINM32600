...
double CurrencyConverter(double& localValue, int& localCurrency, int& foreignCurrency){
    ...
    std::cout << localC->GetSymbol() << std::endl;
    std::cout << localC->GetExchangeRate() << std::endl;

    std::cout << ForeignC->GetSymbol() << std::endl;
    std::cout << ForeignC->GetExchangeRate() << std::endl;

    double usdValue = localC->ConvertToUSD(localValue);

    std::cout << usdValue << std::endl;

    double foreignValue = ForeignC->ConvertFromUSD(usdValue);

    std::cout << foreignValue << std::endl;
